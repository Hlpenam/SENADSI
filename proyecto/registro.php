<?php // valores de registro para ingresar informacion 
	...
	$link = mysql_connect("localhost","parklot","directv..02") or die("<h2>No se encuentra el servidor</h2>");// a l conectarse por php ingresamos normal menteo cy si no la excepcion dira que no se pudo conextar al servidor
	$db = mysql_select_db("academias",$link) or die("<h2>Error de Conexion</h2>"); // la variable db debe ser igual a la conexion en el archivo de php conexion.php
